...
insert into Post (ID, photo, utente, descr, beds, city, address, services, squareMetres, tipologia)
values (100002, LOAD_FILE('C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Accommodations/house2.jpg'), "Jesse", "Amazing Bed and Breakfast in the middle of Amsterdam, only 5 minutes walking from Central Station and 3 min walking from Dam Square .", "4", "Amsterdam", "Van Hallstrat", null, "20 - 39", "studio flat");
